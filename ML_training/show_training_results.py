model_name_i="mask_rcnn_shapes_b.h5"
save_i=0
...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, model_name_i)
...
if save_i:
	cv2.imwrite(name+'.jpg',original_image)
...
for z in range(len(mask[0][0])):
    	...
    	#print(mask_i.shape)
    	#print(i)
    	cv2.imwrite('mask/image_mask'+str(z)+'.jpg',mask_i)
